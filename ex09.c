...
int main(int argc,char* argv[])
{
    ...
    cubeMap = LoadCubeMap(file, 0);
//    reflectCubeMap = LoadCubeMap(file, 1);
    ...
    shader[0] = CreateShaderProg("vertexblinn.vert","vertexblinn.frag");
    texMapLocation = glGetUniformLocation(shader[0], "texMap");
    GLuint texunit = 0;
    glUniform1i(texMapLocation, texunit);
